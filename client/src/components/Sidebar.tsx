    ...
    return (
        <div className=" h-screen bg-emerald-800 text-white flex flex-col p-5 font-mono">
            ...
            <ul className="flex-grow space-y-4">
                <li onClick={()=>navigate('/')} className="flex items-center px-2 py-3 rounded-lg hover:bg-emerald-600">
                ...
                <li onClick={()=>navigate('/activities')} className="flex items-center px-2 py-3 rounded-lg hover:bg-emerald-600">
                    <i className="bx bx-activity text-xl mr-3"></i>
                    <span>Activities</span>
                </li>                
                <li onClick={()=>navigate('/notes')} className="flex items-center px-2 py-3 rounded-lg hover:bg-emerald-600">
                    <i className="bx bx-note text-xl mr-3"></i>
                    <span>Notes</span>
                </li>
                <li onClick={()=>navigate('/teams')} className="flex items-center px-2 py-3 rounded-lg hover:bg-emerald-600">
