    ...
    return (
        <div className="flex items-center justify-between bg-gray-100 h-16 px-6 shadow font-mono">
            ...
            <div className="relative ">
                <a href="#" className="rounded-full bg-emerald-800 text-gray-200 p-2 text-center hover:bg-emerald-500">Sign Up</a>
                <a href="#" className="ml-4 rounded-full bg-emerald-800 text-gray-200 p-2 text-center hover:bg-emerald-500">Sign In</a>
            </div>
        </div>
    );
}
